...
class Agent(Base):
    ...
    function_type: Mapped[str] = mapped_column(
        String(40), nullable=False, server_default="call_screener"
    )
    ...
    __table_args__ = (
        ...
        Index("uq_agents_user_default", "owner_user_id", unique=True),
        Index("agents_owner_user_id_idx", "owner_user_id"),
    )
