...
from sqlalchemy import Boolean, CheckConstraint, DateTime, ForeignKey, Index, Integer, LargeBinary, String, text
...
class MfaMethod(Base):
    ...
    __table_args__ = (CheckConstraint("method_type IN ('totp', 'email_otp')", name="ck_mfa_methods_type"), Index("uq_mfa_methods_primary_active", "owner_user_id", unique=True), Index("mfa_methods_user_idx", "owner_user_id"),)
