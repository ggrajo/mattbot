...
class UserSettings(Base):
    ...
    quiet_hours_intervals: Mapped[str] = mapped_column(
    ...
    contact_category_defaults: Mapped[str] = mapped_column(
        JsonbDict, nullable=False, server_default="{}"
    )
    custom_contact_categories: Mapped[str] = mapped_column(
        JsonbDict, nullable=False, server_default="[]"
    )
    ...
    __table_args__ = (
        ...
        CheckConstraint(
            "data_retention_days IN (7, 30, 90)", name="ck_user_settings_retention_days"
        ),
        CheckConstraint(
            "max_call_length_seconds BETWEEN 120 AND 300", name="ck_user_settings_max_call"
        ),
        CheckConstraint(
            "vip_max_call_length_seconds BETWEEN 180 AND 600", name="ck_user_settings_vip_call"
        ),
        CheckConstraint(
        ...
        CheckConstraint(
            "repeat_caller_threshold BETWEEN 1 AND 10", name="ck_user_settings_repeat_threshold"
        ),
        CheckConstraint(
        ...
        CheckConstraint(
            "calendar_booking_window_days BETWEEN 1 AND 60", name="ck_user_settings_calendar_window"
        ),
    )
