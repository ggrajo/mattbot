...
class CallEvent(Base):
    ...
    __table_args__ = (UniqueConstraint("call_id", "event_type", "provider_status", name="uq_call_events_dedupe"), Index("call_events_call_idx", "call_id"), Index("call_events_user_idx", "owner_user_id"),)
