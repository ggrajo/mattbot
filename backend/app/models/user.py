...
class User(Base):
    ...
    onboarding: Mapped["OnboardingState | None"] = relationship(
        "OnboardingState",
        back_populates="user",
        cascade="delete,delete-orphan,expunge,merge,refresh-expire,save-update",
        uselist=False,
    ...
    billing_payment_methods: Mapped[list["BillingPaymentMethod"]] = relationship(
        "BillingPaymentMethod",
        back_populates="user",
        cascade="delete,delete-orphan,expunge,merge,refresh-expire,save-update",
    )
    billing_usage: Mapped["BillingUsage | None"] = relationship(
        "BillingUsage",
        back_populates="user",
        cascade="delete,delete-orphan,expunge,merge,refresh-expire,save-update",
        uselist=False,
    )
    user_number: Mapped["UserNumber | None"] = relationship(
        "UserNumber",
        back_populates="user",
        cascade="delete,delete-orphan,expunge,merge,refresh-expire,save-update",
        uselist=False,
    )
    call_mode_config: Mapped["CallModeConfig | None"] = relationship(
        "CallModeConfig",
        back_populates="user",
        cascade="delete,delete-orphan,expunge,merge,refresh-expire,save-update",
        uselist=False,
    )
    forwarding_verification_attempts: Mapped[list["ForwardingVerificationAttempt"]] = relationship(
