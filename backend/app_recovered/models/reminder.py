...
class Reminder(Base):
    ...
    __table_args__ = (CheckConstraint("status IN ('scheduled', 'triggered', 'completed', 'cancelled')", name="ck_reminders_status"), Index("reminders_user_due_idx", "owner_user_id", "due_at"), Index("reminders_scheduled_due_idx", "due_at"),)
