...
class Session(Base):
    ...
    device: Mapped["Device | None"] = relationship("Device", back_populates="sessions", uselist=False)

    __table_args__ = (Index("sessions_user_idx", "owner_user_id"), Index("sessions_device_idx", "device_id"), Index("sessions_active_by_device_idx", "device_id"), Index("sessions_refresh_exp_idx", "refresh_expires_at"),)
